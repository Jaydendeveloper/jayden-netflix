...
useEffect(() => {
  ...
  return (
    <MuiModal open={showModal} onClose={handleClose} className="fixex !top-7 left-0 right-0 z-50 mx-auto w-full max-w-5xl overflow-hidden oveflow-x-scroll rounded-md scrollbar-hide">
        <>
        ...
        <div className="flex space-x-16 rounded-b-md bg-[#181818] px-10 p-8">
            <div className="space-y-6 text-lg">
                <div className="flex items-center space-x-2 text-sm">
                    ...
                    <p  className="font-light">
                        {movie!.release_date || movie?.backdrop_path.first_air_date}
                    </p>
